...
$usersResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/usuarios" 
Method Get 
Write-Host "`nServicio de Usuarios:" -ForegroundColor Yellow 
$usersResponse.data | ConvertTo-Json 
# Test Servicio de Pedidos 
$ordersResponse = Invoke-RestMethod -Uri "http://localhost:5001/api/pedidos" 
Method Get 
...
$userOrders = Invoke-RestMethod -Uri "http://localhost:5001/api/pedidos/1" 
Method Get 
